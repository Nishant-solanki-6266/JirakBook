                ...
                <div className="Contra-modal-overlay">
                    <div className="Contra-modal-content Contra-large-modal">
                        ...
                        <div className="Contra-modal-footer">
                            <button className="Contra-btn-print" onClick={handlePrint} style={{ backgroundColor: '#8ce043', color: 'white', border: 'none', padding: '10px 20px', borderRadius: '8px', fontWeight: '600', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px' }}>
